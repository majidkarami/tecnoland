...
class SearchController extends Controller
{
    ...
    public function search(Request $request,$cat1,$cat2,$cat3)
    {
        ...
        if(sizeof($get)>0)
        {
            ...
            return View('technoland.site.search',[
                'filter'=>$filter,
    ...
    public function ajax_search(Request $request)
    {
        if($request->ajax())
        {
            ...
            return view('technoland.include.product_list',['product'=>$data['product'],'cat_url'=>$cat_url,'total_product'=>$data['total_product']]);
        }
    ...
    public function show_cat1($cat1,$cat2)
    {
        ...
        if($this->view=='')
        {
            ...
            return View('technoland.site.product_cat2',['data'=>$data,'category1'=>$category1,'price'=>$price,'cat_url'=>$cat_url,'cat_list'=>$cat_list,'category2'=>$category2]);
        }
        else
        {
            ...
            return View('search/show_cat',['slider'=>$slider,'category2'=>$category2,'cat_list'=>$cat_list,
    ...
    public function show_cat_product($cat1,$cat2,$cat3)
    {
        ...
        if($this->view=='')
        {
            ...
            return View('technoland.site.product_cat3',['data'=>$data,'category1'=>$category1,'price'=>$price,'cat_url'=>$cat_url,'cat_list'=>$cat_list,'category2'=>$category2,'category3'=>$category3]);
        ...
        else
        {
            ...
            return View('search/product',['products'=>$products,'filter'=>$filter,'category3'=>$category3,'price'=>$price]);
    ...
    public function cat1($cat)
    {
        ...
        return View('technoland.site.product_cat1',['data'=>$data,'category1'=>$category,'price'=>$price,'cat_url'=>$cat_url,'cat_list'=>$cat_list]);
    }
    ...
    public function show_cat4($cat1,$cat2,$cat3,$cat4)
    {
        ...
        return View('technoland.site.product_cat4',['data'=>$data,'category1'=>$category1,'price'=>$price,'cat_url'=>$cat_url,'cat_list'=>$cat_list,'category2'=>$category2,'category3'=>$category3,'category4'=>$category4]);
