                ...
                <aside class="sidebar-page col-12 col-sm-12 col-md-4 col-lg-3 order-1">
                    <div class="box">
                        ...
                        <div class="box-content category-result">
                            <ul>
                                <li><a href="#">{{ $category4->cat_name }}</a>
                                    <ul>
                                        @foreach($cat_list as $key=>$value)
                                            <li><a href="{{ url('category').'/'.$category4->cat_ename.'/'.$value->cat_ename }}">{{ $value->cat_name }}</a></li>
                                        @endforeach
                                    </ul>
                                </li>
                            </ul>
                ...
                <div class="col-12 col-sm-12 col-md-8 col-lg-9 order-2">
                    <div class="breadcrumb-section default">
                        <ul class="breadcrumb-list">
                            ...
                            <li><span><a href="{{ url('category').'/'.$category4->cat_ename }}">{{ $category4->cat_name }}</a></span></li>
                        </ul>
                    </div>
