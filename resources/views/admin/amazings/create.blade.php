            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <form id="myForm" method="post" action="{{route('amazings.store')}}">
                            @csrf
                            <div class="form-group">
                                <label for="title">عنوان</label>
                                <input type="text" name="title" value="{{old('title')}}" class="form-control" placeholder="عنوان محصول شگفت انگیز را وارد کنید...">
                                @if($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="m_title" value="{{old('m_title')}}"  class="form-control" placeholder="عنوانک محصول شگفت انگیز را وارد کنید...">
                            ...
                            <div class="form-group">
                                <label>توضیحات</label>
                                <textarea id="textareaDescription" type="text" name="tozihat" class="ckeditor form-control" placeholder="توضیحات محصول را وارد کنید...">{{old('tozihat')}} </textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="price1" value="{{old('price1')}}" class="form-control" placeholder="هزینه اصلی محصول را وارد کنید...">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="price2" value="{{old('price2')}}" class="form-control" placeholder="هزینه محصول با تخفیف را وارد کنید...">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="time" {{old('time')}} class="form-control" placeholder="مدت زمان شگفت انگیز بر حسب ساعت ...">
                                @if($errors->has('time'))
